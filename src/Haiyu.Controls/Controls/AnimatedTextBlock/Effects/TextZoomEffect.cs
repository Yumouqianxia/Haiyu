using Haiyu.Controls.AnimatedTextBlock.Enums;
using Haiyu.Controls.AnimatedTextBlock.Internals;
...
namespace Haiyu.Controls.AnimatedTextBlock.Effects;
...
public partial class TextZoomEffect : ITextEffect
{
        ...
        using (ds.CreateLayer(opacityProgress))
        {
            ...
            ds.DrawText(
                newCluster.IsTrimmed
                    ? GenerateTrimmingSign(newTextLayout)
    ...
    public static string GenerateTrimmingSign(CanvasTextLayout layout)
    {
        return "\u2026";
    }
