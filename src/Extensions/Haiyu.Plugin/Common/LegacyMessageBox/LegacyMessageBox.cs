...
namespace Haiyu.Plugin.Common.LegacyMessageBox;
...
public static class LegacyMessageBox
{
    ...
    {
        return ShowBase(hwnd, message, "Unknown Product", messageBoxStyle);
    }
    ...
    {
        return ShowBase(hwnd, message, "Unknown Product", MessageBoxStyle.Ok);
    }
    ...
    {
        return ShowBase(hwnd, message, "", MessageBoxStyle.Ok | MessageBoxStyle.IconInformation);
    }
    ...
    {
        return ShowBase(hwnd, message, "Unknown Product", MessageBoxStyle.Ok | MessageBoxStyle.IconError);
    }
    ...
    {
        return ShowBase(hwnd, message, "Unknown Product", MessageBoxStyle.Ok | MessageBoxStyle.IconWarning);
    }
